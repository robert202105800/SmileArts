                            ...
                            <div class="col-md-6">
                                ...
                                <form method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="old_pass" class="form-control" autocomplete="off" placeholder="Enter your Old Password">
                                    </div>
                                    <div class="form-group">
                                        <label> New Password</label>
                                        <input type="password" name="new_pass" class="form-control" autocomplete="off" placeholder="Enter your New Password">
                                    </div>
                                    <div class="form-group">
